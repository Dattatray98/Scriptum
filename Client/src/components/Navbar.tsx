...
const Navbar: React.FC<any> = ({ LoginOpen }) => {
  ...
  return (
    <nav
      className={`z-50 backdrop-blur-3xl border-gray-50 flex justify-between items-center px-4 transition-all duration-500 ${IsScroll
          ? "fixed top-0 w-full h-18 border-b"
